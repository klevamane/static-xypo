...
![Design preview for the Huddle landing page with alternating feature blocks coding challenge](./images/design/design.png)

## Welcome! 👋

## Where to find everything

Your task is to build out the project to the designs inside the `/images/design` folder. You will find both a mobile and a desktop version of the design to work to. 
